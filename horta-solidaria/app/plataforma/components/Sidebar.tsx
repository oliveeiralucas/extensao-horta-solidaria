...
const menuItems: MenuItem[] = [
  { label: 'Dashboard', icon: RiHome2Line, link: '/plataforma/dashboard' },
  {
    ...
    subItems: [
      ...
      { label: 'Doações Realizadas', link: '/plataforma/doacoes/doacoes-realizadas' }
    ]
  },
  {
    label: 'Configurações',
    ...
    subItems: [
      { label: 'Configurar Aplicação', link: '/plataforma/configuracoes/configuracoes-site' },
      { label: 'Configurar Perfil', link: '/plataforma/configuracoes/configuracoes-perfil' }
    ]
  }
]
